...
namespace LOTM.Client.Game.Objects
{
    class WizardOfWisdom : PlayerObject
    {
        ...
        public WizardOfWisdom(Vector2 position = null, double rotation = 0, Vector2 scale = null, NetworkInstanceType instanceType = default, int networkId = -1, double health = default)
